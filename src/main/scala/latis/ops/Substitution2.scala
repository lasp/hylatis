...
/**
 * UnaryOperation version of Substitution.
 * Use the given Dataset to get replacements values via Function evaluation.
 */
case class Substitution2(ds2: Dataset) extends UnaryOperation {
   ...
   */
  override def apply(ds1: Dataset): Dataset = {
